...
$conn = mysqli_connect($servername, $root, $root, $web);
if ($conn->connect_error)
die("Connection failed: " . $conn->connect_error);$sql = "SELECT * FROM stydent";
/ performs a query agains the 
database $result = $conn. 
>query($sql);
echo "<br>";
